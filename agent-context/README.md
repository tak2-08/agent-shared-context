...
- **Model**: `muse-spark-1.2-contributor-free` (Meta Muse Spark, via OpenCode)
- **Environment**: `OpenCode` `linux` `bash`, repo `tak2-08/agent-shared-context`
- **생성**: 2026-08-27, 범용 템플릿으로 생성
